...
pub struct Config {
    ...
    #[envconfig(
        from = "CONTRACTS_SECOND_CHAIN_L1_ERC20_BRIDGE_PROXY_ADDRS",
        default = "[]"
    )]
    ...
    #[envconfig(
        from = "CONTRACTS_SECOND_CHAIN_WITHDRAWAL_FINALIZER_CONTRACTS",
        default = "[]"
    )]
    ...
    #[envconfig(from = "BATCH_FINALIZATION_GAS_PRICE")]
    pub finalize_gas_price: String,
